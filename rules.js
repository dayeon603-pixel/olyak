...
window.OLYAK_RULES = (function () {
  ...
  // ── 한국형 PIM 2018 (노인 부적절 약물) : name이 있으면 개별약, 없으면 계열 단위
  //    reason=위험 요지, alt=대안(선택)
  const pim = [
    { cls: "sedative",        reason: "어르신에게 낙상·인지저하·섬망 위험이 높은 약입니다.", alt: "비약물 수면요법 우선, 필요 시 단기·최소용량" },
    { cls: "zdrug",           reason: "낙상·야간섬망 위험이 있어 어르신에게 주의가 필요합니다.", alt: "수면위생 개선 우선" },
    { cls: "anticholinergic", reason: "항콜린 작용(구갈·변비·배뇨장애·인지저하)이 강해 어르신에게 주의가 필요합니다.", alt: "2세대 항히스타민 등 항콜린 적은 약" },
    { cls: "musclerelax",     reason: "진정·항콜린 작용이 있고 효과 근거가 약해 어르신에게 권장되지 않습니다.", alt: "물리치료·비약물 요법 우선" },
    { cls: "su",              reason: "장기작용 설폰요소제는 지속적 저혈당 위험이 있습니다.", alt: "단기작용 SU 또는 DPP-4 억제제 등" },
    { cls: "digoxin",         reason: "고용량(>0.125mg/일)에서 독성 위험이 큽니다. 용량·신장기능 확인이 필요합니다.", alt: "저용량 유지 및 농도 모니터링" },
    { cls: "amiodarone",      reason: "QT연장·갑상선·폐 독성 위험이 있어 어르신에게 정기 모니터링이 필요합니다.", alt: "" },
    { name: "파록세틴",       cls: "ssri", reason: "SSRI 중 항콜린 부담이 높아 어르신에게 덜 권장됩니다.", alt: "에스시탈로프람 등 항콜린 적은 SSRI" },
    { name: "이부프로펜",     cls: "nsaid", reason: "장기 복용 시 위장출혈·신장·혈압 위험이 있는 어르신 주의약입니다.", alt: "아세트아미노펜 우선, 필요 시 최단기간" },
    { name: "나프록센",       cls: "nsaid", reason: "장기 복용 시 위장출혈·신장 위험이 있는 어르신 주의약입니다.", alt: "아세트아미노펜 우선" },
  ];
  ...
  return { drugs, ddi, triples, dup, pim, scores, alias, catColor, medIcon };
})();
